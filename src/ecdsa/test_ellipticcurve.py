...
class TestAffineMultiplicationCost(unittest.TestCase):
    ...
    def test_a_point_that_knows_no_order_keeps_the_affine_ladder(self):
        ...
        because a point without an order still has to multiply, and no secret
        of this library reaches it.  Signing and key generation use ordered
        ...
        implementation, which is what an ECDH exchange against a decoded peer
        key multiplies, recodes such a point against its curve instead; see
